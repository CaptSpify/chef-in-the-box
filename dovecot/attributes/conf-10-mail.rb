...
default['dovecot']['conf']['mail_location'] = 'mbox:~/mail:INBOX=/home/%u'
default['dovecot']['conf']['mail_uid'] = 'dovecot'
default['dovecot']['conf']['mail_gid'] = 'dovecot'
default['dovecot']['conf']['mail_privileged_group'] = "dovecot"
...
default['dovecot']['conf']['mail_temp_dir'] = '/var/mail/temp'

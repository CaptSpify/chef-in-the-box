...
default['mysql']['tunable']['back_log']             = "64"
default['mysql']['tunable']['key_buffer']           = "128M"
default['mysql']['tunable']['max_allowed_packet']   = "8M"
default['mysql']['tunable']['max_connections']      = "400"
default['mysql']['tunable']['max_heap_table_size']  = "16M"
default['mysql']['tunable']['myisam_recover']       = "BACKUP"
default['mysql']['tunable']['net_read_timeout']     = "15"
default['mysql']['tunable']['net_write_timeout']    = "15"
default['mysql']['tunable']['table_cache']          = "64"
default['mysql']['tunable']['table_open_cache']     = "64"
default['mysql']['tunable']['thread_cache']         = "64"
default['mysql']['tunable']['thread_cache_size']    = 4
default['mysql']['tunable']['thread_concurrency']   = 5
...
default['mysql']['tunable']['innodb_log_file_size']            = "2M"
default['mysql']['tunable']['innodb_buffer_pool_size']         = "64M"
default['mysql']['tunable']['innodb_additional_mem_pool_size'] = "4M"
default['mysql']['tunable']['innodb_data_file_path']           = "ibdata1:5M:autoextend"
...
default['mysql']['tunable']['expire_logs_days']     = 5
default['mysql']['tunable']['max_binlog_size']      = "00M"

...
cookbook_file "#{node['nagios']['conf_dir']}/example.key" do
  source "example.key"
  owner "root"
  group "root"
  mode 00644
...
cookbook_file "#{node['nagios']['conf_dir']}/example.crt" do
  source "example.crt"
  owner "root"
  group "root"
  mode 00644
...
cookbook_file "#{node['nagios']['docroot']}/healthcheck.txt" do

...
set['nagios']['nrpe']['command_timeout']   = "30"
...
# These are integers, not percentages
default['nagios']['checks']['memory']['warning']  = 10  
default['nagios']['checks']['memory']['critical'] = 5
default['nagios']['checks']['load']['warning']    = "15,10,5"
default['nagios']['checks']['load']['critical']   = "30,20,17"

...
set['nagios']['https'] = true
set['nagios']['http_port']  = "80"
set['nagios']['https_port']  = "443"
set['nagios']['server_name'] = node.has_key?(:domain) ? "nagios.#{domain}" : "example.com"
...
default['nagios']['sysadmin_email']          = "admin@example.com"
default['nagios']['sysadmin_sms_email']      = "fake"
...
default['nagios']['default_host']['retry_interval']     = 20
default['nagios']['default_host']['max_check_attempts'] = 1
default['nagios']['default_host']['notification_interval'] = 30

default['nagios']['default_service']['check_interval']     = 60
default['nagios']['default_service']['retry_interval']     = 20
default['nagios']['default_service']['max_check_attempts'] = 3
default['nagios']['default_service']['notification_interval'] = 30

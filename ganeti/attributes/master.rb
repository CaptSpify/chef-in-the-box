...
default['ganeti']['xend-config']['dom0-min-mem'] = "512"
...
default['ganeti']['xend-config']['xend-http-server'] = "no"
default['ganeti']['xend-config']['xend-unix-server'] = "no"
default['ganeti']['xend-config']['xend-tcp-xmlrpc-server'] = "no"
default['ganeti']['xend-config']['xend-unix-xmlrpc-server'] = "no"
default['ganeti']['xend-config']['xend-relocation-server'] = "no"
default['ganeti']['xend-config']['xend-relocation-port'] = "8022"
...
default['ganeti']['xend-config']['vncpasswd'] = "poopscicles"
...
default['ganeti']['lvm']['devices']['pv_min_size'] = "1024"
...
# global
default['ganeti']['lvm']['global']['umask'] = "127"
...
# grub
default['ganeti']['grub']['GRUB_DEFAULT'] = "0"
default['ganeti']['grub']['GRUB_TIMEOUT'] = "5"
default['ganeti']['grub']['GRUB_DISTRIBUTOR'] = "lsb_release -i -s 2> /dev/null || echo Debian"
default['ganeti']['grub']['GRUB_CMDLINE_LINUX_DEFAULT'] = "quiet"
default['ganeti']['grub']['GRUB_CMDLINE_LINUX'] = ""
default['ganeti']['grub']['GRUB_CMDLINE_XEN'] = "dom0_mem=400M"

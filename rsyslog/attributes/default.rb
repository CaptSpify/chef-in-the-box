...
default['rsyslog']['relp_port']                 = 215
default['rsyslog']['protocol']                  = 'tcp'
default['rsyslog']['port']                      = 214
default['rsyslog']['server_ip']                 = nil
default['rsyslog']['server_search']             = 'role:syslog'
default['rsyslog']['remote_logs']               = true
default['rsyslog']['per_host_dir']              = '%$YEAR%/%$MONTH%/%$DAY%/%HOSTNAME%'
default['rsyslog']['max_message_size']          = '4k'
default['rsyslog']['preserve_fqdn']             = 'true'
